...
expected = [
    ...
    hasattr(init_mocked, '_url'),
    hasattr(init_mocked, 'cache_poster'),
    hasattr(init_mocked, 'soup'),
    hasattr(init_mocked, 'synopsis'),
    hasattr(init_mocked, '_poster_url'),
    hasattr(init_mocked, '_save_poster_file'),
    hasattr(init_mocked, '_poster_file'),
    hasattr(init_mocked, 'make_poster_name'),
    hasattr(init_mocked, 'do_poster_png_file')
]
...
def test_poster_name(run_init):
    ...
    assert file_name[-1] == 'Um_Sonho_de_Liberdade_(1994).png'
